...
def upgrade():
    ...
    op.create_foreign_key(None, 'answers', 'parents', ['parent_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key(None, 'products', 'parents', ['parent_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key(None, 'questions', 'parents', ['parent_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(None, 'questions', 'products', ['product_id'], ['id'], ondelete='CASCADE')
...
def downgrade():
    ...
    op.drop_constraint(None, 'questions', type_='foreignkey')
    op.create_foreign_key('questions_product_id_fkey', 'questions', 'products', ['product_id'], ['id'])
    op.create_foreign_key('questions_parent_id_fkey', 'questions', 'parents', ['parent_id'], ['id'])
    op.drop_constraint(None, 'products', type_='foreignkey')
    op.create_foreign_key('products_parent_id_fkey', 'products', 'parents', ['parent_id'], ['id'])
    ...
    op.create_foreign_key('answers_parent_id_fkey', 'answers', 'parents', ['parent_id'], ['id'])
    # ### end Alembic commands ###
