...
def downgrade():
    ...
    op.create_foreign_key('questions_parent_id_fkey', 'questions', 'parents', ['parent_id'], ['cpf'])
    op.alter_column('questions', 'question',
               existing_type=sa.Text(),
               type_=sa.VARCHAR(length=2200),
               existing_nullable=False)
    op.drop_constraint(None, 'products', type_='foreignkey')
    op.create_foreign_key('products_parent_id_fkey', 'products', 'parents', ['parent_id'], ['cpf'])
    op.drop_constraint(None, 'answers', type_='foreignkey')
    op.create_foreign_key('answers_parent_id_fkey', 'answers', 'parents', ['parent_id'], ['cpf'])
    op.alter_column('answers', 'parent_id',
