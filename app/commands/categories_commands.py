...
def categories_cli():
    ...
    categories_description_list = [
        ...
        "Carrinhos para o seu bebê sem idade específica",
        "Roupas para o seu bebê sem idade específica",
        ...
        "Brinquedos para o seu bebê sem idade específica",
    ...
    def create_categories():
        ...
        for x in range(len(categories_names_list)):
            categories.append(
                CategoryModel(description=categories_description_list[x]))
